            ...
            ...widget.options.map(
                ...
                child: FlatButton(
                  ...
                  onPressed: () async {
                    ...
                    SharedPreferences pre = await SharedPreferences.getInstance();
                    // String ans=pre.getString('time_answered') ?? "";
                    int difference = DateTime.now().difference(DateTime.parse(pre.getString('time_answered') ?? DateTime(2000).toIso8601String())).inSeconds;
                    pre.setString('time_answered', DateTime.now().toIso8601String());
                    pre.setInt('difference', difference);
